...
import mgmix.dev.collection_of_android_project.databinding.FragmentPlayerBinding
...
class PlayerFragment : Fragment(R.layout.fragment_player) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        initMotionEvent(fragmentPlayerBinding)
        initRecyclerViewBinding(fragmentPlayerBinding)
    ...
    private fun initMotionEvent(fragmentPlayerBinding: FragmentPlayerBinding) {
        fragmentPlayerBinding.playerMotionLayout.setTransitionListener(object :
            ...
            override fun onTransitionChange(
                ...
                binding?.let {
                    (activity as YoutubeActivity).also { mainActivity ->
    ...
    private fun initRecyclerViewBinding(fragmentPlayerBinding: FragmentPlayerBinding) {
